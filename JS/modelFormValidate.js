...
const phoneInput = document.getElementById('model-input__phone')
const emailInput = document.getElementById('model-input__email')
const messageName = document.getElementById('model-error__name')
const messagePhone = document.getElementById('model-error__phone')
const messageEmail = document.getElementById('model-error__email')
