function replaceContentForMobile() {
    if (window.innerWidth <= 1025) {
        ...
        var contentHeader = document.getElementById("header");
    ...
    const toggleMenuDisplay = () => {
        ...
        closeBurger.style.display = header.classList.contains("mobile-header")
            ? "block"
            : "none";
        navigationPage.style.display = header.classList.contains("mobile-header")
            ? "block"
            : "none";
        navigationButton.style.display = header.classList.contains("mobile-header")
            ? "block"
            : "none";
    };
